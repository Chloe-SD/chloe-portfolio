        ...
        <div className="mx-auto max-w-6xl px-4 py-16 lg:py-24 grid gap-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 pt-4" aria-label="Choose your path">
            {[{
              ...
              body: "Explore production-ready projects featuring multi-tenant UI patterns, secure auth, and real-time data.",
              href: "#projects",
              cta: "View Portfolio →",
            },{
              title: "For Businesses",
              body: "Need a reliable, accessible website? I build clean, mobile-friendly sites that are easy to maintain.",
              href: "#services",
              cta: "See Services →",
            }].map((card) => (
              <motion.a
        ...
        {/* Projects Section */}
          ...
          <div className="mx-auto max-w-6xl px-4 py-16 grid gap-10">
            <header className="flex items-end justify-between">
              ...
              <a href="https://github.com/Chloe-SD" className="text-sm text-rose-700 hover:underline">GitHub →</a>
            </header>
            <ProjectsSection/>
          </div>
        </section>
