  ...
  return (
    <div className="min-h-screen text-slate-200 flex flex-col bg-fixed-image">
      <div className="bg-slate-950 bg-opacity-70 min-h-screen flex flex-col">
        ...
        <main
          id="main-content"
          className="flex-grow flex flex-col pt-16 md:pt-20"
        >
          {/* HERO SECTION */}
          <section
            id="home"
          ...
          >
            <div className="mx-auto max-w-6xl px-4 py-16 lg:py-24 grid gap-8">
              ...
              >
                ...
                <br />
                From the security and efficiency your business needs, to the
                accessible user-experience your customers deserve.
              </motion.p>
              ...
              >
                <a
                  href="#projects"
                  className="inline-flex items-center rounded-xl bg-slate-900 text-white px-5 py-3 font-medium shadow-sm 
              ...
              focus:outline-none focus:ring-4 focus:ring-amber-400"
                ...
                <a
                  href="#services"
                  className="inline-flex items-center rounded-xl border border-rose-400 px-5 py-3 font-medium 
              hover:bg-slate-700"
                >
                  Work With Me
                </a>
              ...
              >
                {[
                  ...
                  >
                    <h2 className="text-xl text-rose-300 font-semibold mb-2">
                      {card.title}
                    </h2>
                    <p>{card.body}</p>
                    <span className="mt-3 inline-block text-amber-700 group-hover:underline">
                      {card.cta}
                    </span>
                  </motion.a>
                ))}
          ...
          <section id="contact" className="border-t border-slate-200">
            <div className="mx-auto max-w-6xl px-4 py-16 grid lg:grid-cols-2 gap-8">
              <div>
                ...
                <p className="mt-2">
                  Tell me about your project or role. I usually respond within
                  1-2 business days.
                </p>
                <ul className="mt-4 text-sm grid gap-1">
                  ...
                  <li>
                    <a
                      className="underline underline-offset-4"
                      href="https://www.linkedin.com/in/chloe-nibali/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      LinkedIn: Chloe Nibali
                    </a>
                  </li>
                </ul>
              </div>
